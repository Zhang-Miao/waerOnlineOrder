    ...
    <script type="text/javascript">
        function save() {
            if ($("#gname").val().length == 0) {
                ...
                $.ajax({
                    type:"post",
                    url: "${pageContext.request.contextPath}/goods/ajaxedit",
                    data: {gtid: $("#gtid").val(), gname: $("#gname").val(),gid: $("#gid").val()},
                    success: function (data) {
                        if (data === "t") {
                            $("#msg").html("*该类型的菜品名称已经存在，请重新输入");
                        }
                        else if (data === "f") {
                            window.location.href = "${pageContext.request.contextPath}/goods/edit?"+$("#forms").serialize();
                        }
                    }
                })
            }
    ...
    <div class="span12">
        <form class="form-horizontal"
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select name="gtid" id="gtid">
                        <c:forEach items="${gtype}" var="item">
                            <c:choose>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="gname" id="gname" value="${goods.gname}" onblur="ajaxedit()"/>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <input type="hidden" name="gimg" id="gimg" value="${goods.gimg}"/>
                </div>
                <div class="controls">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="gprice" id="gprice" value="${goods.gprice}"/>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" name="gtime" id="gtime" value="${goods.gtime}"/>
                </div>
            </div>
